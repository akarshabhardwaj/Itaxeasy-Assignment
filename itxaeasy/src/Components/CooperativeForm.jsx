...
const Cooperative = () => {
    ...
    const [bae, setBae] = useState("no");
    const [bac, setBac] = useState("no");
                        ...
                        <TableContainer >
                            <Table variant='striped' colorScheme='gray'>
                                ...
                                <Tbody>
                                    ...
                                    <Tr>
                                        <Td>Co-operative society opted and qualify for section 115BAD

                                        </Td>

                                        <Td isNumeric>
                                            <Select border="1px solid gray" onChange={(e) => { setBac(e.target.value) }}>
                                    ...
                                    <Tr>
                                        <Td>Co-operative society opted and qualify for section 115BAE

                                        </Td>

                                        <Td isNumeric>
                                            <Select border="1px solid gray" onChange={(e) => { setBae(e.target.value) }} >
                                                <option value='option1'>Select</option>
                                                <option value='yes'>Yes</option>
                                                <option value='no'>No</option>
                                            </Select>
